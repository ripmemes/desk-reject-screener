    ...
    def step_2(self, pdf_path, evaluation_context : list) : # formating , margins
        try : 
            ...
            step_2_prompt_test = (
                ...
                "determine if the document violates conference formatting guidelines. IMPORTANT! : Look very closely at the margins and see if they are too small, if yes then reject it, mention the results of this step in your detailed justification"
            )
            step_2_prompt = (
                "Focusing now on document layout compliance, review your "
                "previous page count conclusions from the prior conversation step, and focus "
    ...
    def step_3(self, pdf_path, evaluation_context : list) : # deals with parsed text, checks anonymity ( names and links ), citations, scientific integrity ( attempts to do prompt injection ) 
        try:
            ...
            step_3_prompt_test = (
                ...
                "4. Bibliography & Citation Integrity: Scrutinize the references section at the end of the text. Look for severely malformed bibliographic information, placeholder text (e.g., 'Author, A. 2026'), or obviously hallucinated conferences/page numbers. Compare against the specific violation patterns shown in the anchor cases.\n\n"
